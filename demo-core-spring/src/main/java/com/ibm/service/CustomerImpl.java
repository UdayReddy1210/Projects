...
public class CustomerImpl implements Customer{
    ...
    List<CustomerBean> customers = new ArrayList<>(Arrays.asList(
    		new CustomerBean(1,"Park","Hyd",10001,"12/10/1998"),
	        new CustomerBean(2,"BurjAlArab","Dubai",10002,"12/10/1998"),
	        new CustomerBean(3,"Raddison","Delhi",10003,"03/03/198"),
	        new CustomerBean(4,"Marriot","Mumbai",10004,"12/10/1998")
    		));
        @Override
